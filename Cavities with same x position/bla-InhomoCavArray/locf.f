...
c     
      ...
      real fp1,fpds1,fpds3,fpds4,fpds6,fpds7
      ...
      real rad,lam,lam0
      real depth,xcenter,length,width,chi1,chi2
      integer iplane,num_Cav,i,fpds2
      real zcenter(50),fpds5(50)
...
c      end function chi
     ...
     &  width,x1,y1,z1)
      ...
      implicit none      
      real depth,xcenter,length,zcenter(num_Cav),width,x1,y1,z1  
      real pi
      integer i,num_Cav
      parameter (pi = 3.1415926535897932385)
      ...
      if (y1.le.depth) then
      	chi=1.
      	if (x1.ge.(xcenter-length/2).and.
     &      x1.le.(xcenter+length/2)) then
      	  do i=1,num_Cav
	    if (z1.ge.(zcenter(i)-width/2).and.
