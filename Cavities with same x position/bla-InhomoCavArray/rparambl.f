...
c
      if (loctyp.eq.13) then
         ...
         if (my_node.eq.0) then
            ...
            write(ios,*) '   num_Cav    ',fpds2
            write(ios,*) '   xcenter    ',fpds3
            write(ios,*) '   length    ',fpds4
            write(ios,*) '   zcenter    ',fpds5
            write(ios,*) '   width    ',fpds6
            write(ios,*) '   tscale    ',fpds7           
         end if
      end if	
c
